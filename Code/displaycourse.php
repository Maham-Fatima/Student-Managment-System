...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <button type='submit' class='edit-button-course' data-id='{$row["courseId"]}'>Edit</button>
    <button type='submit' class='delete-button-course' data-id='{$row["courseId"]}'>Delete</button>
    </td>    
</tr>";
}
$data .= "</tbody>
