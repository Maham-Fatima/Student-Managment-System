...
$sql = "SELECT * FROM CourseAssignment a JOIN faculty f ON a.fid = f.ID JOIN course c ON a.cid = c.courseId";
...
<th scope='col' class='md:px-6 md:py-3 px-2 py-1 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>Faculty Name</th>     
<th scope='col' class='md:px-6 md:py-3 px-2 py-1 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>Faculty email</th>        
</tr>
</thead>
